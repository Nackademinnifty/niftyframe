            ...
            <article>
               <div class="col-xs-12 col-md-5">
                ...
                <figure class="pull-right col-xs-12 col-md-6">
                    <a target="_top" href="img/work/training.jpg"><img class="img-responsive" src="img/work/training.jpg" alt="training365 page Responsive image"></a>
                </figure>
            </article>
        </section>
